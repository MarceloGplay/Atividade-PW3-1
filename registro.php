    ...
    <main role="main" class="container">
        ...
        <div class="row">
            <div class="col-sm-4 offset-sm-4 border bg-white">
                ...
                <p class="text-center">Preencha os campos para criar uma conta</p>
                ...
                <form action="" method="">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="mail" name="email" class="form-control" placeholder="Nome completo" aria-label="E-mail" aria-describedby="basic-addon1">
                    </div>
